                ...
                <header className="h-14 border-b border-zinc-800 flex items-center justify-between px-6 bg-zinc-950/80 backdrop-blur-sm z-30">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-sm flex items-center gap-2 font-medium">
                            ...
                            {docType === 'exam' ? 'Sujet d\'Examen' :
                                docType === 'notes' ? 'Notes de Cours' :
                                    docType === 'report' ? 'Rapport de Stage' :
                                        docType === 'cover-letter' ? 'Lettre de Motivation' :
                                            docType === 'manuscript' ? 'Manuscrit' : 'Document sans titre'}
                        </span>
                    </div>
                    <div className="flex items-center gap-4">
                    ...
                    {aiPanelOpen && (
                        <aside className="w-80 border-l border-zinc-800 bg-zinc-900/30 flex flex-col shrink-0 overflow-hidden absolute md:static right-0 h-full backdrop-blur-xl md:backdrop-blur-none z-40 transform transition-transform duration-300 ease-in-out">
                            <div className="p-4 border-b border-zinc-800 flex items-center justify-between">
                                ...
                                <button onClick={() => setAiPanelOpen(false)} className="md:hidden text-zinc-400">
                                    <X className="w-4 h-4" />
                                </button>
                            </div>
