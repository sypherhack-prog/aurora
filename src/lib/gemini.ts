...
export async function processAIRequest({ action, content, theme, documentType }: AIRequest): Promise<string> {
    ...
    switch (action) {
        ...
        case 'continue-writing':
            ...
            - Use sophisticated vocabulary suitable for a ${documentType || 'professional'} context.
            `
            break
        ...
        case 'generate-table':
            prompt = `
            Generate a relevant HTML table for the theme: ${theme} or document type: ${documentType}.
