...
export default function EditorLoading() {
    return (
        <div className="min-h-screen bg-zinc-950 flex">
            {/* Sidebar Skeleton */}
            <aside className="w-64 bg-zinc-900/50 border-r border-zinc-800 hidden md:flex flex-col">
            ...
            <main className="flex-1 flex flex-col">
                ...
                {/* Toolbar Skeleton */}
                <div className="border-b border-zinc-800 px-6 py-3 flex gap-2">
                    {[1, 2, 3, 4, 5].map((i) => (
                        <div key={i} className="w-8 h-8 bg-zinc-800 rounded animate-pulse" />
                    ))}
                </div>
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <span className="text-zinc-400 text-sm">Chargement de l&apos;éditeur...</span>
                    </div>
                </div>
            </main>
        </div>
